...
cvx_begin
    ...
    subject to
        a1'*X - ones(1,20)*b1 > a2'*X - ones(1,20)*b2 - 1
        a1'*X - ones(1,20)*b1 > a3'*X - ones(1,20)*b3 - 1
        a2'*Y - ones(1,20)*b2 > a1'*Y - ones(1,20)*b1 - 1
        a2'*Y - ones(1,20)*b2 > a3'*Y - ones(1,20)*b3 - 1
        a3'*Z - ones(1,20)*b3 > a2'*Z - ones(1,20)*b2 - 1
        a3'*Z - ones(1,20)*b3 > a1'*Z - ones(1,20)*b1 - 1
cvx_end
